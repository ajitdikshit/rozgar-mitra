...
// NOTE: There is intentionally no global full-screen loading overlay here
// anymore. Each page owns its own `loading` state and renders a skeleton
...
// Intercept Responses — handle expired/invalid auth globally
